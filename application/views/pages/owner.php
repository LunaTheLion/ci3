...
<!--/ Contact Star /-->
  <section class="contact">
    <div class="container">
      <div class="row">
        <div class="col-sm-7 section-t8">
          <div class="row">
            <div class="col-sm-12">
              <div class="title-box-d">
                <h3 class="title-d">FOR CONDOMINIUM OWNERS IN FORT BONIFACIO GLOBAL CITY, MAKATI CITY AND ALABANG</h3>
              </div>
            </div>
          </div>
          <div class="owners-page-desc">
            <p class="description">
            If you are the proud owner of a condo unit located in BGC, we can help you in renting it out quickly to a good tenant!
            </p>
            <p class="description no-margin">
            • No fixed fee for advertising; free photo-shoot.
            </p>
            <p class="description no-margin">
            • Commission will be due to us only once there will be a finalized rental contract for you.
            </p>
          </div>
