            ...
            <div class="box-body">
              <div class="row">
                    ...
                    if(!empty($this->session->flashdata('property_type')))
                    {
                     ...
                     <label for="Twin Suite">Property Status</label><br>
                      <?php $status =  $this->session->flashdata('property_status') ?>
                       ...
                       <div class="row">
                         <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                         <input type="radio" name="propertyStatus" id="propertyStatus" value="Rent" <?php if($status === "Rent Only") {echo "checked";} ?> > Rent Only<br> 
                         </div>
                         <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                         <input type="radio" name="propertyStatus" id="propertyStatus" value="Sale" <?php if($status === "Sale Only"){echo "checked";} ?>> Sale Only <br>
                         </div>
                         <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="propertyBed" id="propertyBed" placeholder="Bedroom Count" value="<?php 
