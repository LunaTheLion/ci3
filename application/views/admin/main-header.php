      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown messages-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="label label-success" id="inq"></span>
          </a>
        ...
        <li class="dropdown notifications-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="label label-warning" id='own'></span>
          </a>
          <ul class="dropdown-menu">
        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-header">
              ...
              <p>
               <?php echo ucfirst($this->session->userdata('admin_username')) ?>- <?php if($this->session->userdata('admin_type') == 'super_admin' )
               {
                echo "Super Admin";
               }
               else{
  ...
  $('document').ready(function(){
    ...
    function owner_notif()
    {
      $.ajax({
        ...
        error: function()
        {
          // alert('Could not count new Owners');
        }
      });
    };
